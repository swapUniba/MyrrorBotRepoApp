...
public class LoginActivity extends AppCompatActivity implements LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mEmailSignInButton.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View view) {
                hideKeyboard();
                attemptLogin();
                UserLoginTask userLoginTask = new UserLoginTask(mEmailView.getText().toString(), mPasswordView.getText().toString());
        ...
        if (PreferenceData.getUserLoggedInStatus(this)){//Se "true" allora è già loggato
    ...
    private void attemptLogin() {
        ...
        if (TextUtils.isEmpty(password)) {
            mPasswordView.setError("Password non presente");
    ...
    public class UserLoginTask extends AsyncTask<String, Void, String> {
        ...
        protected String doInBackground(String... strings) {
            ...
            String stringUrl = "http://90.147.102.243:5000/auth/login";//Url per la query
            ...
            try {
                ...
                Log.e(DEBUG_TAG, "Malformed url exception");
                e.printStackTrace();
            } catch (UnsupportedEncodingException e) {
                Log.e(DEBUG_TAG, "Unsupported encoding exception");
                e.printStackTrace();
            } catch (ProtocolException e) {
                Log.e(DEBUG_TAG, "Protocol exception");
                e.printStackTrace();
            } catch (IOException e) {
    ...
    public void hideKeyboard() {
        // controlla che nessuna View ha il focus corrente
